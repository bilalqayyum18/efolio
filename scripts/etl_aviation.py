...
def main() -> None:
    ...
    insights = {
        "findings": [
            ...
            {
                "title": "Islamabad leads international traffic",
                "body": "After merging BBIAP/Chaklala with IIAP (2018), Islamabad is the top Pakistani airport for international passengers under direction-aware aggregation. Karachi leads domestic throughput.",
            },
            {
